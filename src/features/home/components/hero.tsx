...
export function Hero({
  imageSrc,
  imageAlt = "Kristen - Professional Makeup Artist",
}: KristenHeroProps) {
  ...
  return (
    <section className="relative h-[calc(100vh-64px)] w-full overflow-hidden">
      {/* Imagen de fondo */}
      <BackGroundImage imageSrc={imageSrc} alt={imageAlt} className="z-0" />
      ...
      <div className="absolute inset-0 z-20 flex items-end md:items-center">
        <div className="container mx-auto px-6 md:px-12 lg:px-16 pb-20 md:pb-0">
          <div className="max-w-2xl space-y-6 animate-fadeSlideUp">
            ...
            >
              Transformando rostros en obras de arte. Especializada en makeup
              profesional, cosmética de lujo y creación de looks únicos para
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 animate-bounce animation-delay-1000">
